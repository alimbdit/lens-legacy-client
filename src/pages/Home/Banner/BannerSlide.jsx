...
const BannerSlide = ({slide}) => {
    return (
        ...
        <img src={slide} className="w-full h-[calc(100vh-88px)]  object-cover" />
        <div className="absolute flex items-center bg-black bg-opacity-60 h-full w-full">
          <div className="flex justify-center">
            <div className="w-1/2 text-center text-white space-y-10">
              <h1 className="text-7xl font-bold ">Make your Moment</h1>
              <p>
                ...
                embark on a transformative journey of self-expression,
                growth, and endless possibilities.
              </p>
              <div>
                <button className="btn btn-info font-bold text-white mr-5">
                  Discover More
                </button>
